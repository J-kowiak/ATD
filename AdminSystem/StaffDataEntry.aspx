...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:CheckBox ID="chkAdmin" runat="server" style="z-index: 1; left: 10px; top: 177px; position: absolute" Text="Admin" />
            <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 10px; top: 224px; position: absolute"></asp:Label>
            <asp:Button ID="btnOK" runat="server" style="z-index: 1; left: 10px; top: 250px; position: absolute; width: 60px" Text="Ok" OnClick="btnOK_Click" />
            <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 76px; top: 250px; position: absolute; width: 60px" Text="Cancel" />
        </div>
    </form>
</body>
</html>
